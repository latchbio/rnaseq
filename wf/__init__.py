...
def sa_salmon(
    ...
    path_tail = (
        f"{run_name}/Quantification (salmon)/Auxilliary Files"
    )
    if custom_output_dir is None:
        output_literal = "latch:///RNA-Seq Outputs/" + path_tail
    else:
    ...
    aux_files = LatchDir(f"/root/salmon_quant/aux_files", output_literal)
